  ...
  else
  {
    ...
    {     
      ...
      $message = "          
            Hello $uname,
            <br /><br />
            Welcome To GAS DELIVERY SYSTEM<br/>
            To complete your registration  please , just click following link<br/>
            <br /><br />
            <a href='http://localhost/vis/rra/verify.php?id=$id&code=$code'>Click HERE to Activate :)</a>
            <br /><br />
            Thanks,";
    ...
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body">
        ...
        <div class="text-center">
          ...
          <a class="d-block small" href="fpass.php">Forgot Password?</a>
        </div>
      </div>
    </div>
  </div>
