  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Responded</li>
      </ol>
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              <thead>
                <tr>
                  ...
                  <th><i class="fa fa-gas"> </i> PRICE</th>
            ...
            <?php
			include 'dbcon.php';
                                $result = $conn->prepare("SELECT * FROM requests WHERE status='Responded'");
                                $result->execute(array("Responded"));
                ...
                <tr>
                  ...
                  <td><?php echo $row ['msg']; ?></td>
                    <td>
                       <div class="btn-group">
                                      <a class="btn btn-info" href=""><i class="fa fa-envelope"></i><i class="fa fa-check"></i></a>
                                  </div>
                  </td>
                </tr>
                 <?php } ?>      
...
function printdata(){
    ...
    window.print();
			...
			<label id=btn>
                 <a class="btn btn-success" href="" onclick ="printdata()"> &nbsp;PRINT &nbsp;<i class="fa fa-print"></i><i class="fa fa-check"></i></a>
			</label>
                 </div>
                 </td>
            </table>
