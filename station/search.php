...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html">GAS DELIVERY SYSTEM</a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="View Requests">
          <a class="nav-link" href="requests.php">
            ...
            <span class="nav-link-text">View Requests  <span class="badge" style="background-color: darkred;"></span>
          </a>
        </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="View Requests">
          <a class="nav-link" href="sms_request.php">
            ...
            <span class="nav-link-text"> Phone SMS Requests  <span class="badge" style="background-color: darkred;"></span>
          </a>
        </li>
    ...
    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Send Response">
          <a class="nav-link" href="responded_requests.php">
            ...
            <span class="nav-link-text">Responded Requests</span>
          </a>
        </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Send Response">
          <a class="nav-link" href="search.php">
            ...
            <span class="nav-link-text">Gas Search</span>
          </a>
        </li>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Notify Gas Owner</li>
      </ol>
      <div class="row">
        <div class="col-12">
         <div class="content-row">
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <center><form method="POST" action="found.php">
...
<?php
include('dbcon.php');
$result = $conn->prepare("SELECT * FROM customer_details where plaque='$p'");
$result->execute();
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-header">
		  			<h4 class="modal-title" id="myModalLabel">Information From RRA</h4>
		  ...
		  <div class="modal-body">
			...
			<div class="form-group row">
			  <label for="inputPage" class="col-sm-4 col-form-label" style="color:#000000;">VIM</label>
			  <div class="col-sm-8">
				<input name="plaque"type="text" value="<?php echo $vim;?>"class="form-control" id="inputPage" readonly="true">
			  </div>
			</div>
			
			<div class="form-group row">
			  <label for="inputPage" class="col-sm-4 col-form-label" style="color:#000000;">Category</label>
			  <div class="col-sm-8">
				<input name="plaque"type="text" value="<?php echo $vcategory;?>"class="form-control" id="inputPage" readonly="true">
			  </div>
			</div>
			...
			<div class="form-group row">
			  <label for="inputPage" class="col-sm-4 col-form-label" style="color:#000000;">Moteur Number</label>
			  <div class="col-sm-8">
				<input name="plaque"type="text" value="<?php echo $mnumber;?>"class="form-control" id="inputPage" readonly="true">
			  </div>
			</div>
			<div class="form-group row">
			  <label for="inputPage" class="col-sm-4 col-form-label" style="color:#000000;">Fnumber</label>
			  <div class="col-sm-8">
