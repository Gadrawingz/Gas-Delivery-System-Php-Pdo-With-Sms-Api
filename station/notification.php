         ...
         <div class="content-row">
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <center><form method="POST" action="notifications.php">
                                            <div class="form-group">
                                      <input class="form-control" readonly="" type="hidden" name="id" value="<?php echo $rows['id']; ?>">    
                                      <input class="form-control" type="text" name="recipient" value="<?php echo $rows['customer_name']; ?>">
                        ...
                        <div class="form-group">
                          <div class="col-md-offset-2 col-md-10">
							...
							<a type="button" data-toggle="modal" href="#addPage" class="btn btn-success">Before Sending Check Info</a>
                          </div>
                        </div>
                      </form></center>
                    </div>
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-header">
		  			<h4 class="modal-title" id="myModalLabel">Information From Agent</h4>
		  ...
		  <div class="modal-body">
			...
			<div class="form-group row">
			  <label for="inputPage" class="col-sm-4 col-form-label" style="color:#000000;">Price</label>
			  <div class="col-sm-8">
			...
			<div class="form-group row">
			  <label for="inputPage" class="col-sm-4 col-form-label" style="color:#000000;">Gas Model</label>
			  <div class="col-sm-8">
