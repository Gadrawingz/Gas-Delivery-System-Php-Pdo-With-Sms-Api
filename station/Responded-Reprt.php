    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-file" style="color: red"></i>&nbsp; <h1>GAS owner Requests Report (<?php echo $field['m']?>)</h1></div>
        <div class="card-body">
          <div class="table-responsive">
            ...
            <?php
			include 'dbcon.php';
                                $result = $conn->prepare("SELECT * FROM requests WHERE status='Yes' ORDER BY id DESC");
