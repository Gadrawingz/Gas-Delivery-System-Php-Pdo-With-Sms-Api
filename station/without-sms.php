    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-file" style="color: red"></i>&nbsp; <h2>Requests NOT In Process (<?php echo $field['m']?>)</h2></div>
        <div class="card-body">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              <thead>
                <tr>
                  ...
                  <th><i class="fa fa-envelope"></i>  Request</th>
                </tr>
              </thead>
            <?php
			include 'dbcon.php';
                                $result = $conn->prepare("SELECT * FROM requests WHERE status='Not Responded' ORDER BY id DESC");
