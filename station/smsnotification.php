  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
   ...
   $sql = $conn ->prepare("SELECT COUNT(seen_status) as m FROM  requests WHERE status='Not Responded'");
                                          $sql -> execute();
                                           ...
                                           ?>                         
            <span class="nav-link-text">View SMS Requests  <span class="badge" style="background-color: darkred;"><?php echo $field['m'];?></span>
          </a>
        </li>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Notify Gas Owner by SMS</li>
      </ol>
      <div class="row">
        <div class="col-12">
                      ...
                      <center><form method="POST" action="#">
                        ...
                        <div class="form-group">
                          <div class="col-md-offset-2 col-md-10">
							...
							<a type="button" data-toggle="modal" href="#" class="btn btn-success">Before Sending Check Info</a>
                          </div>
                        </div>
                      </form></center>
                    </div>
